      ...
      <div style={{ padding: '40px 32px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        {loading ? (
          ...
          <div style={{ backgroundColor: '#131929', border: '1px solid #1e2d4a', borderRadius: '12px', padding: '60px', textAlign: 'center', color: '#8892a4' }}>
            ...
            <p>Belum ada lamaran. Yuk jelajahi proyek yang tersedia!</p>
            <a href="/app/jelajah" style={{ display: 'inline-block', marginTop: '16px', padding: '10px 20px', backgroundColor: '#4F6EF7', color: 'white', borderRadius: '8px', textDecoration: 'none', fontSize: '14px', fontWeight: 'bold' }}>Jelajah Proyek</a>
          </div>
        ) : (
